...
function main(config){
	...
	Loader.onload = function(){
		...
		var votingSystems = [
			...
			{name:"ezSchulze", realname:"An Easy Version of Schulze that gets the same 1st place winner.", voter:RankedVoter, ballot:"RankedBallot", election:Election.schulze, margin:4},
			{name:"ezRankPair", realname:"An Easy Version of Ranked Pairs that gets the same 1st place winner.", voter:RankedVoter, ballot:"RankedBallot", election:Election.rankedPairs},
			{name:"Condorcet", realname:"Choose the Condorcet Winner, and if there isn't one, Tie", voter:RankedVoter, ballot:"RankedBallot", election:Election.condorcet, margin:100},
