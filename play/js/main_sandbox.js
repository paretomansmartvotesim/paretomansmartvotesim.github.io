    ...
    model.onDraw = function(){
        ...
        if (sankeyOn) {
            if (ui.dom.sankey) {
                ...
                width = 300 - margin.left - margin.right, // was 960
                height = 300 - margin.top - margin.bottom; // was 500
                ...
                ui.sankeywidth = width
                ui.sankeyheight = height
                ui.sankeymargin = margin
            }
        } else {
        ...
        if (sankeyOn) {
            ...
            var width = ui.sankeywidth
            var height = ui.sankeyheight
            var margin = ui.sankeymargin

            if (ui.dom.sankey) ui.dom.sankey.remove() 
            var mydataviz = document.createElement("div")
            mydataviz.id = "chart"
            ui.dom.sankey = mydataviz
            ui.dom.center.append(ui.dom.sankey)


            if(ui.dom.sankeySVG) ui.dom.sankeySVG.remove()
            ui.dom.sankeySVG = d3.select("#chart").append("svg")
            ...
            var energy = getCoalitionDate()
            // var energy = getEnergyData()
