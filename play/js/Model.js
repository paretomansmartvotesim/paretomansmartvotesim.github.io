...
function Model(idModel){
	...
	self.checkSystemWithBarChart = function () {
		return self.system == "QuotaApproval"  || self.system == "QuotaScore" || self.system == "Monroe Seq S" || self.system == "Allocated Score" || self.system == "Phragmen Seq S" || self.system == "RRV" ||  self.system == "RAV" ||  self.system == "STV" || self.system == "equalFacilityLocation"
	}
	...
	self.checkMultiWinner = function(system) {
		return (system == "QuotaApproval"  || system == "QuotaScore" || system == "Monroe Seq S" || system == "Allocated Score" || system == "Phragmen Seq S" || system == "RRV" ||  system == "RAV" ||  system == "STV" || system == "QuotaMinimax" || system == "stvMinimax" || system == "PhragmenMax" || system == "equalFacilityLocation") 
	}
